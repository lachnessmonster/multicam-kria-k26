...
#
# vivado-build-for-kria.tcl: Tcl script for re-creating project 'vivado-build-for-kria'
#
# Generated by Vivado on Wed Aug 26 10:12:59 AEST 2026
...
#
# 1. This project restoration tcl script (vivado-build-for-kria.tcl) that was generated.
#
...
#
#    "/home/lachlan/multicam-kria-k26/vivado-files/constrs_1.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../vivado-files/constrs_1.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "vivado-build-for-kria"
...
set script_file "vivado-build-for-kria.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../dev/vivado-build-for-kria"]"
...
set_property -name "board_part" -value "xilinx.com:kv260_som:part0:2.0" -objects $obj
set_property -name "board_connections" -value "som240_1_connector xilinx.com:kv260_carrier:som240_1_connector:2.0" -objects $obj
...
set file "[file normalize "$origin_dir/../../vivado-files/constrs_1.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../vivado-files/constrs_1.xdc"
...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.MAX_COLS {4672} \
    CONFIG.MAX_DATA_WIDTH {10} \
    CONFIG.MAX_ROWS {3496} \
    CONFIG.SAMPLES_PER_CLOCK {2} \
    CONFIG.USE_URAM {1} \
  ] $v_demosaic_0
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../dev/vivado-build-for-kria/vivado-build-for-kria.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xck26-sfvc784-2LV-c -flow {Vivado Synthesis 2026} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xck26-sfvc784-2LV-c -flow {Vivado Implementation 2026} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
# custom code (non-generated)
# makes the bitstream and binary
...
# This may take a while, ~20 minutes on my computer.
wait_on_run synth_1
launch_runs impl_1 -to_step write_bitstream -jobs 8
wait_on_run impl_1
open_run impl_1
write_bitstream -force -bin_file bitstream_for_kria.bit
